if item_radiance_2 == nil then item_radiance_2 = class({}) end
...
if modifier_radiance_2_stats == nil then modifier_radiance_2_stats = class({}) end
...
function modifier_radiance_2_stats:GetModifierConstantHealthRegen()
...
function modifier_radiance_2_burn:OnCreated()
	if IsServer() then
		...
		self.magical_armor = ability:GetSpecialValueFor("magic_armor")
