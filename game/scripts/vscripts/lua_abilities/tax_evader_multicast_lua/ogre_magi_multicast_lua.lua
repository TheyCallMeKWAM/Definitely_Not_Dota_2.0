...
LinkLuaModifier( "modifier_ogre_magi_multicast_lua", "lua_abilities/tax_evader_multicast_lua/modifier_ogre_magi_multicast_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ogre_magi_multicast_lua_proc", "lua_abilities/tax_evader_multicast_lua/modifier_ogre_magi_multicast_lua_proc", LUA_MODIFIER_MOTION_NONE )
